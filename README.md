...
Official implementation of **BrowserOS-SOPGuard**.

This repository contains the implementation and supplementary artifacts for BrowserOS-SOPGuard, including system prompts used to construct the synthetic webpages, system prompts used for task generation, and example screenshots of synthetic webpages.
...
```text
.
├── packages/                  # BrowserOS and agent implementation 
